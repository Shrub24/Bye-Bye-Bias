...
if __name__ == "__main__":
    ...
    for text in raw_texts:
        ...
        entity_sentiments.append({entity_string: max(min(int(get_doc_sent(text_entity_getter_instance.get_sentence_target_tuples_from_tokens(sentence_target_tuple_input))), 10), 1) for entity_string, sentence_target_tuple_input in text_entity_getter_instance.get_n_important_entities(NUM_MAIN_ENTITIES)})
